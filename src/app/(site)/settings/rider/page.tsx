...
export default function RiderSettingsRoutePage() {
  const modules = MarketplaceSettingsModules.RIDER.cards;

  return (
    <main className="space-y-6 text-slate-950 dark:text-zinc-100">
      <div className="space-y-1">
        <h1 className="text-2xl font-semibold">Rider Settings</h1>
        <p className="text-sm text-muted-foreground">
          Manage rider profile, operations and preferences.
        </p>
      </div>
