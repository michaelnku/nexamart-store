      ...
      <CardContent>
        <form action={updateRiderOperationsModule} className="space-y-6">
          <p className="text-sm text-muted-foreground">
            Verification status:{" "}
            <span
              className={profile?.isVerified ? "text-green-600" : "text-yellow-600"}
            >
              {profile?.isVerified ? "Verified" : "Pending"}
            </span>
          </p>
          <div className="flex items-center justify-between">
            <Label htmlFor="isAvailable">Go Online</Label>
            <Switch
              id="isAvailable"
              name="isAvailable"
        ...
        <div className="mt-4">
          <Link href="/marketplace/dashboard/rider/schedule" className="text-sm text-blue-600">
